...
namespace CoffeeMakerApp
{
    public class Program
    {
        ...
        Func<IEnumerable<FileInfo>> drinkPathDelegate = getDrinkFilePaths;

        static IEnumerable<FileInfo> getDrinkFilePaths()
        {
        ...
        IEnumerable<FileInfo> _drinkFileInfo = drinkPathDelegate();
